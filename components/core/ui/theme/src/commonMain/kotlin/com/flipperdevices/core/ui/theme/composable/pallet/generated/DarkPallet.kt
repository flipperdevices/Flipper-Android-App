...
internal fun getDarkPallet(): FlipperPalletV2 = FlipperPalletV2(
    text = FlipperPalletV2Text(
        title = Title(
            primary = Color(0xFFFFFFFF),
            secondary = Color(0xFFCCCCCC),
            tertiary = Color(0xFF999999),
            whiteOnColor = Color(0xFFFFFFFF),
            blackOnColor = Color(0xFF000000)
        ),
        body = TextBody(
            primary = Color(0xFFFFFFFF),
        ...
        semantic = Semantic(
            success = Color(0xFF34C7A4),
            warning = Color(0xFFFECF5D),
            danger = Color(0xFFF63F3F)
        ),
        link = Link(
            default = Color(0xFF589DFF),
    ...
    surface = Surface(
        ...
        navBar = NavBar(
            body = NavBarBody(
                ...
                accentBrand = Color(0xFFFF8200)
            )
        ),
        menu = Menu(
            body = MenuBody(
                dufault = Color(0xFF333333)
            ),
            separator = MenuSeparator(
                default = Color(0xFF666666)
            )
        ),
        ...
        border = SurfaceBorder(
            ...
            accentBrand = AccentBrand(
                ...
                secondary = Color(0xFF804100),
                tertiary = Color(0xFF492502)
            )
        )
    ),
    action = Action(
        ...
        blue = ActionBlue(
            background = BlueBackground(
                ...
                tertiary = BlueBackgroundTertiary(
                    default = Color(0xFF1B2A41),
                    disabled = Color(0xFF333333)
                ),
                secondary = BlueBackgroundSecondary(
                    default = Color(0xFF465680),
                    disabled = Color(0xFF333333)
                )
            ),
            text = BlueText(
        ...
        fwUpdate = FwUpdate(
            background = FwUpdateBackground(
                ...
                secondary = FwUpdateBackgroundSecondary(
                    default = Color(0xFF176C19),
                    disabled = Color(0xFF333333)
                ),
                tertiary = FwUpdateBackgroundTertiary(
                    default = Color(0xFF092B0A),
                    disabled = Color(0xFF333333)
                ),
                onColor = Color(0xFFFFFFFF)
            ),
        ...
        brunchRc = BrunchRc(
            text = BrunchRcText(
                default = Color(0xFF8A2BE2),
                disabled = Color(0xFF666666)
            )
        ),
        brunchDev = BrunchDev(
            text = BrunchDevText(
                default = Color(0xFFFF3C00),
                disabled = Color(0xFF666666)
            )
        ),
        ...
        danger = ActionDanger(
            ...
            border = DangerBorder(
                ...
                secondary = DangerBorderSecondary(
                    default = Color(0xFF7B1F1F),
                    disabled = Color(0xFF333333)
                ),
                tertiary = DangerBorderTertiary(
                    default = Color(0xFF310D0D),
                    disabled = Color(0xFF333333)
                )
            ),
        ...
        success = ActionSuccess(
            background = SuccessBackground(
                primary = SuccessBackgroundPrimary(
                    default = Color(0xFF34C7A4),
                    disabled = Color(0xFF666666)
                ),
                secondary = SuccessBackgroundSecondary(
                    default = Color(0xFF1A6352),
                    disabled = Color(0xFF333333)
                ),
                tertiary = SuccessBackgroundTertiary(
                    default = Color(0xFF0A2821),
                    disabled = Color(0xFF333333)
                )
            ),
            text = SuccessText(
        ...
        warning = ActionWarning(
            background = WarningBackground(
                primary = WarningBackgroundPrimary(
                    default = Color(0xFFFECF5D),
                    disabled = Color(0xFF666666)
                ),
                secondary = WarningBackgroundSecondary(
                    default = Color(0xFF7F672E),
                    disabled = Color(0xFF333333)
                ),
                tertiary = WarningBackgroundTertiary(
                    default = Color(0xFF332913),
                    disabled = Color(0xFF333333)
                )
            ),
            text = WarningText(
    ...
    illustration = Illustration(
        danger = IllustrationDanger(
            ...
            secondary = Color(0xFF7B1F1F),
            tertiary = Color(0xFF310D0D)
        ),
        success = IllustrationSuccess(
            primary = Color(0xFF34C7A4),
            secondary = Color(0xFF1A6352),
            tertiary = Color(0xFF0A2821)
        ),
        warning = IllustrationWarning(
            primary = Color(0xFFFECF5D),
            secondary = Color(0xFF7F672E),
            tertiary = Color(0xFF332913)
        ),
        neutral = IllustrationNeutral(
            primary = Color(0xFFCCCCCC),
            quaternary = Color(0xFF333333),
            quinary = Color(0xFF1A1A1A),
            tertiary = Color(0xFF666666),
            secondary = Color(0xFF999999)
        ),
        brand = IllustrationBrand(
            primary = Color(0xFFFF8200),
            secondary = Color(0xFF804100),
            tertiary = Color(0xFF190D00)
        ),
        blue = IllustrationBlue(
            primary = Color(0xFF8BACFF),
            secondary = Color(0xFFABCEFF),
            tertiary = Color(0xFF1B2A41)
        ),
        blackAndWhite = IllustrationBlackAndWhite(
            white = Color(0xFF000000),
            black = Color(0xFFE5E5E5),
            whiteOnColor = Color(0xFFFFFFFF),
            blackOnColor = Color(0xFF000000)
        ),
    ...
    category = Category(
        background = CategoryBackground(
            ...
            nfc = BackgroundNfc(
                default = Color(0xFF98CEFF),
                disabled = Color(0xFF999999)
            ),
            infrared = BackgroundInfrared(
                default = Color(0xFFFF928B),
                disabled = Color(0xFF999999)
            ),
            ibutton = BackgroundIbutton(
                default = Color(0xFFE1BBA6),
                disabled = Color(0xFF999999)
            ),
            badUsb = BackgroundBadUsb(
                default = Color(0xFFFFBEE9),
                disabled = Color(0xFF999999)
            ),
            gpio = BackgroundGpio(
                default = Color(0xFFA7F2EA),
                disabled = Color(0xFF999999)
            ),
            games = BackgroundGames(
                default = Color(0xFFFFBF7C),
                disabled = Color(0xFF999999)
            ),
            media = BackgroundMedia(
                default = Color(0xFFDFB5FF),
                disabled = Color(0xFF999999)
            ),
            tools = BackgroundTools(
                default = Color(0xFFDFF159),
                disabled = Color(0xFF999999)
            ),
            bluetooth = BackgroundBluetooth(
                default = Color(0xFF8BACFF),
                disabled = Color(0xFF999999)
            )
        ),
        icon = CategoryIcon(
    ...
    icon = FlipperPalletV2Icon(
        neutral = IconNeutral(
            primary = IconNeutralPrimary(
                default = Color(0xFFCCCCCC),
                transparent = Color(0x80FFFFFF)
            ),
            secondary = IconNeutralSecondary(
                default = Color(0xFF999999),
                transparent = Color(0x4DFFFFFF)
            ),
            tertiary = IconNeutralTertiary(
                default = Color(0xFF666666),
                transparent = Color(0x1AFFFFFF)
            ),
        ...
        blue = IconBlue(
            primary = Color(0xFF589DFF),
            secondary = Color(0xFF2C4E80),
            tertiary = Color(0xFF1B2A41)
        )
    )
)
