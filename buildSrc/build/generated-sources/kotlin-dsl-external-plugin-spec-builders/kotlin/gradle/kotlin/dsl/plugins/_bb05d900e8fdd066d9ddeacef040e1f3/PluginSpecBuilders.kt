...
package gradle.kotlin.dsl.plugins._bb05d900e8fdd066d9ddeacef040e1f3
...
/**
 * The `com.squareup.anvil` plugin implemented by [com.squareup.anvil.plugin.AnvilPlugin].
 */
internal
val `ComSquareupPluginGroup`.`anvil`: PluginDependencySpec
    get() = plugins.id("com.squareup.anvil")
...
/**
 * The `io.sentry` plugin group.
 */
@org.gradle.api.Generated
internal
class `IoSentryPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `io.sentry`.
 */
internal
val `IoPluginGroup`.`sentry`: `IoSentryPluginGroup`
    get() = `IoSentryPluginGroup`(plugins)


/**
 * The `io.sentry.android` plugin group.
 */
@org.gradle.api.Generated
internal
class `IoSentryAndroidPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `io.sentry.android`.
 */
internal
val `IoSentryPluginGroup`.`android`: `IoSentryAndroidPluginGroup`
    get() = `IoSentryAndroidPluginGroup`(plugins)


/**
 * The `io.sentry.android.gradle` plugin implemented by [io.sentry.android.gradle.SentryPlugin].
 */
internal
val `IoSentryAndroidPluginGroup`.`gradle`: PluginDependencySpec
    get() = plugins.id("io.sentry.android.gradle")
